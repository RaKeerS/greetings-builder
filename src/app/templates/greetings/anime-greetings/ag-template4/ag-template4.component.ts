...
export class AgTemplate4Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template4/images/kisame-hoshikage-wallpaperflare.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template4/template-preset-messages/ag-template4-preset-messages.json';
