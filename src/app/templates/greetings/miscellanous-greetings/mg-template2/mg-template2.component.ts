...
export class MgTemplate2Component implements OnInit {
  ...
  private imageUrl1: string = './../../assets/greetings/miscellanous-greetings/mg-template2/images/valentines-day-image.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/miscellanous-greetings/mg-template2/template-preset-messages/mg-template2-preset-messages.json';
