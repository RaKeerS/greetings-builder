...
export class AgTemplate8Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template8/images/hidan-wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template8/template-preset-messages/ag-template8-preset-messages.json';
