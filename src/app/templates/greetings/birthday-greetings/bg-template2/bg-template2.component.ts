...
export class BgTemplate2Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/birthday-greetings/bg-template2/images/36321522405737710.gif';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/birthday-greetings/bg-template2/template-preset-messages/bg-template2-preset-messages.json';
