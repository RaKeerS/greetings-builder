...
@Component({
  selector: 'app-ag-template9',
  templateUrl: './ag-template9.component.html',
  styleUrls: ['./ag-template9.component.css']
})
export class AgTemplate9Component implements OnInit {

  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template9/images/orochimaru-wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template9/template-preset-messages/ag-template9-preset-messages.json';
