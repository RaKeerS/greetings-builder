...
@Component({
  selector: 'app-ag-template3',
  templateUrl: './ag-template3.component.html',
  styleUrls: ['./ag-template3.component.css']
})
export class AgTemplate3Component implements OnInit {

  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template3/images/art-nona-naruto-itachi-uchiha.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template3/template-preset-messages/ag-template3-preset-messages.json';
