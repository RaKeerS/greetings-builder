...
export class AgTemplate2Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template2/images/Pain-1-Wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template2/template-preset-messages/ag-template2-preset-messages.json';
