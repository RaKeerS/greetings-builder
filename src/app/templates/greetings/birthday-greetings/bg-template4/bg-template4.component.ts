...
export class BgTemplate4Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/birthday-greetings/bg-template4/images/87611522748975988.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/birthday-greetings/bg-template4/template-preset-messages/bg-template4-preset-messages.json';
