...
export class AgTemplate5Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template5/images/sasori-wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template5/template-preset-messages/ag-template5-preset-messages.json';
