...
@Component({
  selector: 'app-ag-template6',
  templateUrl: './ag-template6.component.html',
  styleUrls: ['./ag-template6.component.css']
})
export class AgTemplate6Component implements OnInit {

  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template6/images/deidara-wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template6/template-preset-messages/ag-template6-preset-messages.json';
