...
export class BwgTemplate1Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/best-wishes-greetings/bwg-template1/images/happy-fathers-day-image.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/best-wishes-greetings/bwg-template1/template-preset-messages/bwg-template1-preset-messages.json';
