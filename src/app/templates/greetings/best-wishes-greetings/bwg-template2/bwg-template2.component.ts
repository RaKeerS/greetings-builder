...
export class BwgTemplate2Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/best-wishes-greetings/bwg-template2/images/happy-mothers-day-image.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/best-wishes-greetings/bwg-template2/template-preset-messages/bwg-template2-preset-messages.json';
