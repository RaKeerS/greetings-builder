...
export class BwgTemplate3Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/best-wishes-greetings/bwg-template3/images/happy-fathers-day-image.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/best-wishes-greetings/bwg-template3/template-preset-messages/bwg-template3-preset-messages.json';
