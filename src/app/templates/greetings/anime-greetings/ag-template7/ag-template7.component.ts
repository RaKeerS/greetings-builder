...
@Component({
  selector: 'app-ag-template7',
  templateUrl: './ag-template7.component.html',
  styleUrls: ['./ag-template7.component.css']
})
export class AgTemplate7Component implements OnInit {

  private imageUrl1: string = '../../../../../assets/greetings/anime-greetings/ag-template7/images/kakuzu-wallpaper.jpg';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/anime-greetings/ag-template7/template-preset-messages/ag-template7-preset-messages.json';
