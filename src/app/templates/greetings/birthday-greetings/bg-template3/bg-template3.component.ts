...
export class BgTemplate3Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/birthday-greetings/bg-template3/images/1451577359453383.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/birthday-greetings/bg-template3/template-preset-messages/bg-template3-preset-messages.json';
