...
export class MgTemplate1Component implements OnInit {
  ...
  private imageUrl1: string = '../../../../../assets/greetings/miscellanous-greetings/mg-template1/images/world-environment-day-image-1.png';
  private imageUrl2: string = '../../../../../assets/greetings/miscellanous-greetings/mg-template1/images/world-environment-day-image-2.png';
  private templatePresetMessagesUrl: string = '../../../assets/greetings/miscellanous-greetings/mg-template1/template-preset-messages/mg-template1-preset-messages.json';
